...
(function () {
  ...
  function loadGiscus() {
    ...
    script.setAttribute("data-repo-id", "R_kgDOQec2Ow"); // 실제 값으로 교체 필요
    script.setAttribute("data-category", "General");
    script.setAttribute("data-category-id", "DIC_kwDOQec2O84CzIzW"); // 실제 값으로 교체 필요
  ...
  function showError(message) {
    ...
    if (contentEl) {
      contentEl.innerHTML =
        '<p class="loading" style="color: var(--color-text-muted);">' +
        escapeHtml(message) +
        "</p>";
    }
  }
